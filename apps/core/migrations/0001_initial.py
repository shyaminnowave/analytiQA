    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Please Enter the TestCase Name', max_length=255, unique=True, verbose_name='Test Report Name')),
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_testcase', to='account.account', to_field='email')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='stb.natcorelease')),
                ('testcase', models.ForeignKey(default='', max_length=255, on_delete=django.db.models.deletion.CASCADE, to='core.testcasemodel')),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('todo', 'Todo'), ('ongoing', 'Ongoing'), ('completed', 'Completed')], default='todo', max_length=20)),
                ('testcase', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='test_steps', to='core.testcasemodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', django_extensions.db.fields.CreationDateTimeField(auto_now_add=True, verbose_name='created')),
                ('modified', django_extensions.db.fields.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('script_name', models.CharField(default='', max_length=200, unique=True)),
                ('script_location', models.URLField()),
                ('script_type', models.CharField(choices=[('performance', 'Performance'), ('soak', 'Soak'), ('smoke', 'Smoke')], max_length=20)),
                ...
                ('device', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='device_supported', to='stb.stbmanufacture')),
                ('language', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='script_language', to='stb.language')),
                ...
                ('natCo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='natCo_script', to='stb.natco')),
                ...
                ('testcase', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='testcase_script', to='core.testcasemodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('script', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='scripts', to='core.testcasescript')),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('devices', models.ManyToManyField(blank=True, related_name='supported_devices', to='stb.STBManufacture')),
                ('language', models.ManyToManyField(blank=True, related_name='supported_languages', to='stb.Language')),
                ...
                ('natcos', models.ManyToManyField(blank=True, related_name='supported_natcos', to='stb.Natco')),
                ...
                ('testcase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='natco_support', to='core.testcasemodel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='natco_status', to='core.testcasemodel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testcase', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.testcasemodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, help_text='Please Enter the TestCase Name', max_length=255, verbose_name='Test Report Name')),
                ('priority', models.CharField(choices=[('class_1', 'Class 1'), ('class_2', 'Class 2'), ('class_3', 'Class 3')], default='class_3', max_length=20)),
                ('summary', models.TextField(default='', verbose_name='Jira Summary')),
                ('description', models.TextField(default='', verbose_name='TestCase Description')),
                ('testcase_type', models.CharField(choices=[('performance', 'Performance'), ('soak', 'Soak'), ('smoke', 'Smoke')], default='smoke', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_case', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.testcasemodel')),
